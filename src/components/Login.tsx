                ...
                <TabsContent value="login">
                  <form onSubmit={handleLogin} className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-gray-500 mb-2">Correo asociado a tu cuenta</p>
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-gray-500 mb-2">Tu contraseña de acceso</p>
                      <div className="relative">
                ...
                <TabsContent value="register">
                  <form onSubmit={handleRegister} className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-gray-500 mb-2">Mínimo 5 caracteres, incluye nombre y apellido</p>
                      <div className="relative">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-gray-500 mb-2">Proporciona un correo válido y activo</p>
                      <div className="relative">
                        <Mail className="absolute left-3 top-3 h-4 w-4 text-gray-400" />
                        <Input 
                          id="reg-email"
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-gray-500 mb-2">Mínimo 8 caracteres: mayúsculas, minúsculas, números y caracteres especiales (!@#$%^&*)</p>
                      <div className="relative">
                        <Lock className="absolute left-3 top-3 h-4 w-4 text-gray-400" />
                        <Input 
                          id="reg-password"
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-gray-500 mb-2">Debe ser idéntica a la contraseña anterior</p>
                      <div className="relative">
                        <Lock className="absolute left-3 top-3 h-4 w-4 text-gray-400" />
                        <Input 
                          id="confirm-password"
