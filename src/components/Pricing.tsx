    ...
    <section id="tariffs" className="py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <Badge className="mb-3" variant="outline">Tarifas</Badge>
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900">Precios competitivos y transparentes</h2>
          <p className="mt-4 max-w-2xl mx-auto text-xl text-gray-600">
            Ofrecemos tarifas flexibles para diferentes necesidades de estacionamiento.
          </p>
        </div>
        ...
        <div className="mt-16 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          <Card className="border-2 border-primary/20">
            <CardHeader className="text-center pb-4">
              <div className="mx-auto bg-primary/10 w-14 h-14 flex items-center justify-center rounded-full mb-4">
                <Clock className="h-6 w-6 text-primary" />
              </div>
              <h3 className="text-2xl font-bold text-gray-900">Tarifa por Hora</h3>
            </CardHeader>
            <CardContent>
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span className="text-gray-600">Pago por el tiempo exacto</span>
                </li>
                <li className="flex items-start">
                  <svg className="h-5 w-5 text-green-500 mr-2 mt-0.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-gray-600">Sin tiempo mínimo</span>
                </li>
                <li className="flex items-start">
                  <svg className="h-5 w-5 text-green-500 mr-2 mt-0.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-gray-600">Ideal para visitas cortas</span>
                </li>
              </ul>
            </CardContent>
          </Card>
          ...
          <Card className="border-2 border-primary relative">
            ...
            <CardHeader className="text-center pb-4 pt-7">
              ...
              <h3 className="text-2xl font-bold text-gray-900">Tarifa Diaria</h3>
            </CardHeader>
            <CardContent>
              <div className="text-center mb-6">
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span className="text-gray-600">Estacionamiento por 24 horas</span>
                </li>
                <li className="flex items-start">
                  <svg className="h-5 w-5 text-green-500 mr-2 mt-0.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-gray-600">Entrada y salida ilimitadas</span>
                </li>
                <li className="flex items-start">
                  <svg className="h-5 w-5 text-green-500 mr-2 mt-0.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-gray-600">Ideal para turistas y visitantes</span>
                </li>
                <li className="flex items-start">
                  <svg className="h-5 w-5 text-green-500 mr-2 mt-0.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-gray-600">Ahorro del 25% vs tarifa horaria</span>
                </li>
              </ul>
            </CardContent>
          </Card>
          ...
          <Card className="border-2 border-primary/20">
            <CardHeader className="text-center pb-4">
              ...
              <h3 className="text-2xl font-bold text-gray-900">Tarifa Mensual</h3>
            </CardHeader>
            <CardContent>
              <div className="text-center mb-6">
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span className="text-gray-600">Plaza de parqueadero garantizada</span>
                </li>
                <li className="flex items-start">
                  <svg className="h-5 w-5 text-green-500 mr-2 mt-0.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-gray-600">Acceso 24/7 con tarjeta</span>
                </li>
                <li className="flex items-start">
                  <svg className="h-5 w-5 text-green-500 mr-2 mt-0.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-gray-600">Ideal para residentes y trabajadores</span>
                </li>
                <li className="flex items-start">
                  <svg className="h-5 w-5 text-green-500 mr-2 mt-0.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-gray-600">Ahorro significativo a largo plazo</span>
                </li>
              </ul>
            </CardContent>
          </Card>
        ...
        <div className="mt-12 text-center">
          <p className="text-gray-600">
            * Los precios pueden variar según la ubicación. Consulte cada parqueadero para detalles específicos.
          </p>
        </div>
      </div>
    </section>
